...
export const metadata: Metadata = {
  title: 'Minivan with Driver Morocco | Group Transfers | MarHire',
  description: 'Book a comfortable minivan with a professional driver for group travel in Morocco. Perfect for families, corporate events, and group tours. Seats up to 8 passengers.',
};

const vanFeatures = [
    { icon: UserCheck, title: 'Ideal for Group Travel', description: 'With seating for up to 8 passengers, our minivans are perfect for families, friends, and corporate groups.' },
...
export default function MinivanDriverPage() {
  return (
    <div className="flex min-h-screen w-full flex-col bg-background">
      <AppHeader />
      <main className="flex-1">
        <CategoryHero
          title="Hire a Minivan with a Private Driver in Morocco"
          description="The perfect solution for group travel. Book a spacious and comfortable minivan with a professional driver for your family vacation, group tour, or business event. Available for airport transfers, intercity travel, and day trips."
        ...
        >
         ...
         <div className="space-y-8 py-12 md:space-y-16 md:py-16">
            <WhyBookCategory
                title="Benefits of Hiring a Minivan with a Driver"
                features={vanFeatures}
            />
            
            <CategoryBrowseSection
                title="Find a Minivan with a Driver by City"
                items={cities}
            ...
            <div className="container">
                <PopularDestinations basePath="/private-drivers/minivan" />
            </div>
        </div>
        <SeoTextSection />
      </main>
