...
export const metadata: Metadata = {
  title: 'Luxury Yacht Charter Morocco | Agadir & Tangier | MarHire',
  description: 'Charter a private luxury yacht in Morocco. Find the best deals on crewed yacht rentals in Agadir and Tangier for day trips, sunset cruises, or special events.',
};
...
const boatListings = MOCK_LISTINGS.filter(l => l.name.toLowerCase().includes('yacht') && !l.name.toLowerCase().includes('party'));

export default function LuxuryYachtPage() {
  return (
      ...
      <main className="flex-1">
        ...
        <div className="space-y-8 py-12 md:space-y-16 md:py-16">
            ...
            <div className="container">
                <PopularDestinations basePath="/boats/luxury-yacht" />
            </div>
        </div>
        <SeoTextSection />
      </main>
