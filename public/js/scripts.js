...
! function(NioApp, $) {
    ...
    NioApp.DataTable.init = function() {
        ...
        NioApp.DataTable('.datatable-colis-init', {
            pageLength: 50,
            order: [],
            responsive: false,
                scrollX: true,
                // Optionally enable scrolling on the vertical axis
                scroller: true,
        });
        NioApp.DataTable('.datatable-nosort-init', {
            pageLength: 50,
            order: [],
            responsive: false,
                scrollX: true,
        ...
        NioApp.DataTable('.datatable-stock-init', {
            pageLength: 50,
            order: [[0, "desc"]],
            responsive: {
                details: true
        ...
        NioApp.DataTable('.datatable-bl-init', {
            pageLength: 50,
            order: [],
            responsive: {
                details: true
        ...
        NioApp.DataTable('.datatable-factures-init', {
            pageLength: 50,
            order: [],
            responsive: {
                details: true
        ...
        NioApp.DataTable('#colisAtraiterTable', {
            pageLength: 50,
            order: [[2, "desc"]],
            responsive: {
                details: true
        ...
        NioApp.DataTable('.datatable-demandes-init', {
            pageLength: 50,
            order: [],
            responsive: {
                details: true
        ...
        NioApp.DataTable('.datatable-ramassages-init', {
            pageLength: 50,
            order: [],
            responsive: {
                details: true
