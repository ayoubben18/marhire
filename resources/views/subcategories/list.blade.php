...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">subcategories</span></h3>
            <div class="nk-block-des text-soft">
                <p>view list of subcategories.</p>
            </div>
        </div>
        <div>
            <a href="{{ route('subcategories.new') }}" class="btn-signup">Add</a>
        </div>
    </div>
</div>
               ...
               <table class="datatable-init nowrap table dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                    ...
                    <tbody>  
                        ...
                        <tr>
                            ...
                            <td>{{ $subcategory->category ? $subcategory->category->category : '' }}</td>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="delete" data-id="{{ $subcategory->id }}">
