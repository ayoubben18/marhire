...
<head>
  <meta charset="UTF-8" />
  <title>MarHire Private Driver Invoice</title>
  <style>
    body {
...
<body>
  <div class="invoice-box">
    <div class="top-section">
      <div class="top-left">
        <h1>MarHire Private Driver Invoice</h1>
      </div>
      <div>
    ...
    <p>
      ...
      <strong>Duration:</strong> {{ $invoiceData['service_duration'] }}<br />
      @endif
    ...
    <table>
      ...
      <tbody>
        ...
        @if(!empty($invoiceData['addons']))
          ...
          @endforeach
        @endif
        <tr><td>Multilingual Driver & Fuel Included</td><td style="text-align: right;">Included</td></tr>
      </tbody>
      <tfoot>
    ...
    <div class="section-title">Service Terms & Policies</div>
    <div class="terms">
      - Driver bookings must be made at least 2 days in advance<br />
      - Fuel, tolls, and parking are included unless stated otherwise<br />
      - Multilingual drivers are available on request<br />
      - Please be ready 15 minutes before pickup time<br />
    ...
    <div class="footer" style="border-top: 1px solid #ddd; padding-top: 20px; margin-top: 40px;">
      ...
      <p style="margin-top: 10px; font-size: 13px; color: #888;">
        Thank you for booking with <strong style="color: #225f54;">MarHire</strong>. Enjoy your ride with our professional drivers.
      </p>
    </div>
  </div>
</body>
