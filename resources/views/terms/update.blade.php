        ...
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des text-soft">
                    <p>Edit the informations of term.</p>
                </div>
            </div>
            <div>
        ...
        <div class="preview-block">
            ...
            <div class="example-alert mb-3">
                <div class="alert alert-success alert-icon">
                    <em class="icon ni ni-check-circle"></em> <strong>Success</strong>. term has been updated.
                </div>
            </div>
            @endif
            ...
            <div class="row gy-4">
                <div class="col-md-6">
                    <div class="form-group">
                         <label class="form-label" for="category">Title <span class="lbl-obligatoire">*</span></label>
                         <div class="form-control-wrap">
                             <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="Title" value="{{ old('title') ?? $term->title }}"/>
                             @error('title')
                ...
                <div class="col-md-12">
                    <div class="form-group">
                         ...
                         <div class="form-control-wrap">
                             <textarea type="text" class="form-control editor" name="content" id="content" placeholder="Description">{{ old('content') ?? $term->content }}</textarea>
                         </div>
                     </div> 
                 </div>
            </div>
