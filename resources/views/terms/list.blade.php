...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Terms</span></h3>
            <div class="nk-block-des text-soft">
                <p>view list of terms.</p>
            </div>
        </div>
        <div>
            <a href="{{ route('terms.new') }}" class="btn-signup">Add</a>
        </div>
    </div>
</div>
                    ...
                    <tbody>  
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="delete" data-id="{{ $term->id }}">
